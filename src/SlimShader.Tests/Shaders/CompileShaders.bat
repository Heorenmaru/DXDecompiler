...
CALL CompileShader2.bat Internal/Misc EffectNoTechnique.fx EffectNoTechnique_5_0_Child_FX fx_5_0 /Gch || GOTO :error
CALL CompileShader2.bat Internal/Misc EffectNoTechnique.fx EffectNoTechnique_4_0_Child_FX fx_4_0 /Gch || GOTO :error
CALL CompileShader2.bat Internal/Misc EffectNoTechnique.fx EffectNoTechnique_4_1_Child_FX fx_4_1 /Gch || GOTO :error
